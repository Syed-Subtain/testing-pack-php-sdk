...
namespace EnumAsTemplateParameterExampleAPILib\Utils;
...
use EnumAsTemplateParameterExampleAPILib\Http\HttpContext;
use EnumAsTemplateParameterExampleAPILib\Http\HttpRequest;
use EnumAsTemplateParameterExampleAPILib\Http\HttpResponse;
