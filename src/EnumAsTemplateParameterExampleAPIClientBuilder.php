...
class EnumAsTemplateParameterExampleAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    public function build(): EnumAsTemplateParameterExampleAPIClient
    {
        return new EnumAsTemplateParameterExampleAPIClient($this->config);
    }
}
